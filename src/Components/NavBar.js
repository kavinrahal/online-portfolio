...
const Navbar=() => {
  ...
  return (
    <header className={x.join(" ")}>
        ...
        <div className = "logo animate__animated animate__fadeInUp animate__delay-3s">
          <img className = "logoimg"></img>
        </div>
        
        <div className="navigation animate__animated animate__fadeInUp animate__delay-3s">
