    ...
    return(
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css"/>
            ...
            <div className = "column" id  = "rightSide">
                <div className = "name animate__animated animate__fadeInUp animate__delay-1s"><h1>KAVINDYA ABEYSINGHE</h1></div>
                <div className = "frontend animate__animated animate__fadeInUp animate__delay-1s"><label>Front-End Developer/UI Designer</label></div>
            </div>
